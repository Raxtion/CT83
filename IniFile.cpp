...
void __fastcall CIniFile::MachineFile(bool bRead)
{
 ...
 //System
  ...
  DDXFile_Float(bRead,pIniFile,Machine_Section,"m_dCleanSprayPosX0",m_dCleanSprayPosX[0],0.0);
  DDXFile_Float(bRead,pIniFile,Machine_Section,"m_dCleanSprayPosY0",m_dCleanSprayPosY[0],0.0);
  DDXFile_Float(bRead,pIniFile,Machine_Section,"m_dCleanSprayPosX1",m_dCleanSprayPosX[1],0.0);
  DDXFile_Float(bRead,pIniFile,Machine_Section,"m_dCleanSprayPosY1",m_dCleanSprayPosY[1],0.0);
  DDXFile_Float(bRead,pIniFile,Machine_Section,"m_dCleanSprayPosX2",m_dCleanSprayPosX[2],0.0);
  DDXFile_Float(bRead,pIniFile,Machine_Section,"m_dCleanSprayPosY2",m_dCleanSprayPosY[2],0.0);
  DDXFile_Float(bRead,pIniFile,Machine_Section,"m_dCleanSprayPosX3",m_dCleanSprayPosX[3],0.0);
  DDXFile_Float(bRead,pIniFile,Machine_Section,"m_dCleanSprayPosY3",m_dCleanSprayPosY[3],0.0);
  DDXFile_Float(bRead,pIniFile,Machine_Section,"m_dCleanSprayPosZ",m_dCleanSprayPosZ,0.0);
  DDXFile_Int(bRead,pIniFile,Machine_Section,"m_nCleanSprayTimes",m_nCleanSprayTimes);
  DDXFile_Float(bRead,pIniFile,Machine_Section,"m_dCleanSprayDistance",m_dCleanSprayDistance,0.0);
  DDXFile_Float(bRead,pIniFile,Machine_Section,"m_dSprayerCleanWaterPressure",m_dSprayerCleanWaterPressure,0.0);
  DDXFile_Float(bRead,pIniFile,Machine_Section,"m_dSprayerCleanAirPressure",m_dSprayerCleanAirPressure,0.0);
  DDXFile_Int(bRead,pIniFile,Machine_Section,"m_nFullCleanSprayTimes",m_nFullCleanSprayTimes);
